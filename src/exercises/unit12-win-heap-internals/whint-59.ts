...
const exercise: Exercise = {
  ...
  steps: [
    ...
    },
    {
      ...
      vizAction: (_sim: any, heap: any) => { if (!heap) return; heap.highlightChunk?.('A', 'header'); heap.annotateField?.('A', 'size', '_HEAP_ENTRY: Size=3'); },
    },
    {
      ...
      vizAction: (_sim: any, heap: any) => { if (!heap) return; heap.highlightChunk?.('B', 'header'); heap.annotateField?.('B', 'size', '_HEAP_ENTRY: Size=9'); },
    },
    {
      action: 'init',
    ...
    },
    {
      ...
      vizAction: (_sim: any, heap: any) => { if (!heap) return; heap.highlightChunk?.('A', 'freed'); heap.annotateField?.('A', 'fd', 'Flink'); heap.annotateField?.('A', 'bk', 'Blink'); },
    },
    {
      ...
      vizAction: (_sim: any, heap: any) => { if (!heap) return; heap.highlightChunk?.('B', 'freed'); heap.annotateField?.('B', 'fd', 'Flink (coalesced)'); },
    },
    {
      action: 'done',
